          ...
          <button
            onClick={async () => {
              try {
                ...
                if (!response.ok) throw new Error('Failed to download orders file');
                ...
                alert('Could not download orders file.');
              }
            }}
            className="flex items-center px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 font-semibold shadow"
          >
