...
export default function Terms() {
  return (
    <div className="w-full min-h-screen flex justify-center items-start bg-white">
      <div className="w-full max-w-4xl px-4 py-12 bg-white shadow-md rounded-lg mt-8 mb-8">
        ...
        <p className="mt-6">For any queries, please contact us at <a href="mailto:jaytraders2008@yahoo.com" className="text-blue-600 underline">jaytraders2008@yahoo.com</a>.</p>
      </div>
    </div>
  );
} 