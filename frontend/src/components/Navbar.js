        ...
        <header className="sticky top-0 z-50 w-full bg-white border-b border-gray-200 shadow-xs">
            ...
            <div className="w-full px-4 sm:px-8 lg:px-12">
                <div className="flex items-center justify-between h-24">
                    ...
                    <div className="hidden md:flex items-center space-x-3 lg:space-x-6 flex-1 justify-start">
                        <Link
                            to="/home"
                            className={`flex items-center space-x-2.5 px-4 py-2.5 rounded-xl text-base font-semibold transition-all duration-200 ${isActiveLink('/home')
                        ...
                        <Link
                            to="/about"
                            className={`flex items-center space-x-2.5 px-4 py-2.5 rounded-xl text-base font-semibold transition-all duration-200 ${isActiveLink('/about')
                                    ? 'bg-red-50 text-red-600 shadow-xs'
                                    : 'text-gray-700 hover:text-red-600 hover:bg-gray-100/80'
                                }`}
                        >
                        ...
                        <Link
                            to="/contact"
                            className={`flex items-center space-x-2.5 px-4 py-2.5 rounded-xl text-base font-semibold transition-all duration-200 ${isActiveLink('/contact')
                                    ? 'bg-red-50 text-red-600 shadow-xs'
                                    : 'text-gray-700 hover:text-red-600 hover:bg-gray-100/80'
                                }`}
                        >
                    ...
                    {/* CENTER SECTION: Centered Brand Logo & Title */}
                    <div className="flex items-center justify-center flex-1">
                        <Link 
                            to="/" 
                            className="flex items-center space-x-3.5 px-6 py-3 rounded-2xl bg-white border border-gray-200 shadow-xs hover:border-red-500 hover:shadow-md group transition-all duration-300"
                        >
                            <div className="relative p-1 bg-gray-50 rounded-xl group-hover:scale-105 transition-transform duration-200">
                                <img
                                    src="/logo.png"
                    ...
                    {/* RIGHT SECTION: Product Categories & Brochure Download */}
                    <div className="hidden md:flex items-center justify-end space-x-3 lg:space-x-4 flex-1">
                        ...
                        <a
                            ...
                            className="flex items-center space-x-2 px-4 py-3 rounded-xl text-base font-semibold text-gray-700 bg-gray-50 hover:bg-red-50 hover:text-red-600 border border-gray-200 transition-all duration-200 shadow-xs"
                        >
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`flex items-center space-x-2.5 px-5 py-3 rounded-xl text-base font-semibold transition-all duration-200 focus:outline-none ${isDropdownOpen || location.pathname.startsWith('/category')
                    ...
                    <div className="flex items-center md:hidden">
                        <button
                            onClick={toggleMenu}
                            className="p-3 rounded-xl bg-gray-50 text-gray-700 hover:text-red-600 hover:bg-red-50 transition-colors"
                        >
            ...
            {isMenuOpen && (
                <nav className="md:hidden border-t border-gray-100 bg-white px-5 pt-4 pb-6 shadow-xl animate-slide-down">
                    <div className="flex flex-col space-y-2.5">
                        <Link
                            to="/home"
                            className={`flex items-center space-x-3.5 p-3.5 rounded-xl text-lg font-semibold transition-colors ${isActiveLink('/home') ? 'bg-red-50 text-red-600' : 'text-gray-700 hover:bg-gray-50'
                                }`}
                            onClick={toggleMenu}
                        >
                        ...
                        <Link
                            to="/about"
                            className={`flex items-center space-x-3.5 p-3.5 rounded-xl text-lg font-semibold transition-colors ${isActiveLink('/about') ? 'bg-red-50 text-red-600' : 'text-gray-700 hover:bg-gray-50'
                                }`}
                            onClick={toggleMenu}
                        >
                        ...
                        <Link
                            to="/contact"
                            className={`flex items-center space-x-3.5 p-3.5 rounded-xl text-lg font-semibold transition-colors ${isActiveLink('/contact') ? 'bg-red-50 text-red-600' : 'text-gray-700 hover:bg-gray-50'
                                }`}
                            onClick={toggleMenu}
                        >
                        ...
                        <a
                            href="/brochure.pdf"
                            download="Jay_Traders_Brochure.pdf"
                            className="flex items-center space-x-3.5 p-3.5 rounded-xl text-lg font-semibold text-gray-700 bg-gray-50 hover:bg-red-50 hover:text-red-600 transition-colors"
                            onClick={toggleMenu}
                        >
                        ...
                        <div className="pt-2 border-t border-gray-100">
                            <button
                                onClick={toggleDropdown}
                                className={`flex items-center justify-between w-full p-3.5 rounded-xl text-lg font-semibold text-gray-700 hover:bg-gray-50 transition-colors ${isDropdownOpen ? 'text-red-600 bg-red-50' : ''
                                    }`}
                            >
...
//             {/* Full-Width Main Navbar Container */}
//             <div className="w-full px-4 sm:px-8 lg:px-12">
//                 {/* Increased Navbar height to h-24 */}
//                 <div className="flex items-center justify-between h-24">
                    
//                     {/* LEFT SECTION: Nav Links with Increased Font Size (text-base) */}
//                     <div className="hidden md:flex items-center space-x-3 lg:space-x-6 flex-1 justify-start">
//                         <Link
//                             to="/home"
//                             className={`flex items-center space-x-2.5 px-4 py-2.5 rounded-xl text-base font-semibold transition-all duration-200 ${isActiveLink('/home')
...
//                     {/* CENTER SECTION: Centered Brand Logo & Title in Red */}
//                     <div className="flex items-center justify-center flex-1">
//                         <Link 
//                             to="/" 
//                             className="flex items-center space-x-3.5 px-6 py-3 rounded-2xl bg-white border border-gray-200 shadow-xs hover:border-red-500 hover:shadow-md group transition-all duration-300"
...
//                     {/* RIGHT SECTION: Product Categories with Increased Font Size */}
//                     <div className="hidden md:flex items-center justify-end space-x-3 lg:space-x-6 flex-1">
//                         <div className="relative">
//                             <button
//                                 ref={dropdownBtnRef}
//                                 onClick={toggleDropdown}
